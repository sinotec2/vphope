...
export { type MarkdownItMathjaxOptions as MathjaxOptions } from "@mdit/plugin-mathjax-slim";
export { type MarkdownItKatexOptions as KatexOptions } from "@mdit/plugin-katex-slim";
