...
<h4 align="center">VuePress style config plugin 🎨 / VuePress 樣式配置外掛程式 🎨</h4>
...
VuePress palette plugin 🎨 / VuePress 樣式配置外掛程式 🎨

## [Official Docs](https://plugin-sass-palette.vuejs.press/) | [官方文檔](https://plugin-sass-palette.vuejs.press/zh/)
